...
namespace PdfSharp.Tests.IO
{
    ...
    public class ReaderTests
    {
        ...
        [Fact]
        public void Test_Incorrect_EndDictionary_After_EndStream_Before_EndObj()
        {
            const string path =
                @"C:\Code\Data\DocumentAnalysis\260820240741\Files\06890ad0-bd56-4f4f-97bd-8cfb06a50f82.pdf";
            using var doc = PdfReader.Open(path, PdfDocumentOpenMode.Import);
            var elements    = doc?.Info?.Elements;
        }

        [Fact]
        public void Test_Exstram_incorrect_beginstream_token()
        {
            const string path =
                @"C:\Code\Data\DocumentAnalysis\260820240741\Files\0ce4dc82-5b48-4597-944f-8ca39e209b26.pdf";
            using var doc = PdfReader.Open(path, PdfDocumentOpenMode.Import);
            var elements    = doc?.Info?.Elements;
        }
    }
